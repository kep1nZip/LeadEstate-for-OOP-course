...
<html lang="id">
    ...
    <%
        ...
        for (int i = 0; i < Math.min(2, namaParts.length); i++) {
            if (namaParts[i].length() > 0) {
                inisialSB.append(namaParts[i].charAt(0));
            }
        }
    ...
    <body class="bg-[#f5f4f0] font-sans text-gray-800 antialiased">
        ...
        //  CHART.JS — CHART DONAT (Status Lead)
            (function () {
                ...
                const total = statusData.reduce(function (a, b) {
                    return a + b;
                }, 0);
